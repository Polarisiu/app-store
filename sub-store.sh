...
declare -A commands=(
    ...
    [4,17]='bash <(curl -sL https://raw.githubusercontent.com/Polarisiu/app-store/main/DNSMgrwsq.sh)'
    [4,18]='bash <(curl -sL https://raw.githubusercontent.com/Polarisiu/app-store/main/vps-value.sh)'
