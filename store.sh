...
install_service() {
    case "$1" in
        ...
        27) bash <(curl -sL https://raw.githubusercontent.com/iu683/app-store/main/jdtuc.sh) ;;
        28) bash <(curl -fsSL https://raw.githubusercontent.com/iu683/app-store/main/ytdlb.sh) ;;
        88)
